...
Viewed as a grave breach of discipline with zero tolerance.
...
- Fabrication or the falsification of any information with the intent to deceive.

- Forgery, alteration, or misuse of university documents or records.

## attendance_requirement

Students must attend a reasonable portion (not less than 80%) of the lectures, tutorials, and practical classes.
...
# academic_status_and_disciplinary_action

## probation_and_dismissal

### undergraduate

CGPA below 2.25 leads to probation; CGPA below 1.0 after the first two or any subsequent semesters leads to automatic dismissal.

### graduate

CGPA below 2.60 leads to probation; failure to raise it after two consecutive semesters leads to dismissal.

## general_penalties

- Warning (written or verbal notice).

- Cancellation of the examination and/or an assignment.

- Expulsion for one or more semesters.

- Expulsion from the university (final dismissal).

## disciplinary_procedure

Allegations are examined by the Discipline Committee, which recommends penalties to the authority. Penalties are reflected in the student's Academic Transcripts/documents.
